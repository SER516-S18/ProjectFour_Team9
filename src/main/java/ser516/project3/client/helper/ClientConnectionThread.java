...
public class ClientConnectionThread implements Runnable {
	 ...
	 * @param endpoint
	 *            - The URI end point of the web socket
	 */
	...
	public void run() {
		...
		try {
			 ...
			 * if(endpoint.equalsIgnoreCase(ClientConstants.HEALTH_SERVER_ENDPOINT)) {
			 * clientSession =
			 * container.connectToServer(ClientHealthConnectionEndpoint.class,
			 * URI.create(uri)); } else { clientSession =
			...
			JOptionPane.showMessageDialog(dialog, ClientConstants.NO_CONNECTION_MESSAGE, ClientConstants.ERROR_STRING,
