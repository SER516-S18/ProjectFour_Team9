...
public class ServerHealthView extends JFrame implements ViewInterface {
    private static ServerHealthView serverViewInstance = null;
     ...
     *
     */
    public static ServerHealthView getServerView() {
        if (serverViewInstance == null) {
            serverViewInstance = new ServerHealthView();
        }
